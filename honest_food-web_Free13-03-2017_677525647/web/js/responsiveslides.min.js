	...
	c.fn.responsiveSlides=function(l) { 
		...
		F=function(){
			...
			z=function(b) {
				...
				F&&e.show().css
				({"-webkit-transition":"opacity "+h+"ms ease-in-out","-moz-transition":"opacity "+h+"ms ease-in-out","-o-transition":"opacity "+h+"ms ease-in-out",
						...
						if(a.pager&&!a.manualControls)
							{
								...
								(a.pager||a.manualControls)&&k.find("li").each
								(function(a)
									{
