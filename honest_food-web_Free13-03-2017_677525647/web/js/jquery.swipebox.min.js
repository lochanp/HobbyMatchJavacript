										...
										gesture:function(){
											if(c){
												...
												n("body").bind("touchstart",function(e){
													...
													i.pageX=e.originalEvent.targetTouches[0].pageX;n(".touching").bind("touchmove",function(e){
														e.preventDefault();
														e.stopPropagation();
														s=e.originalEvent.targetTouches[0]
													});
														...
														if(this.doCssTrans())
															{
																...
																setTimeout(function()
																	{e.removeClass("visible-bars")},1e3)}
															},
															animBars:function(){
																var e=this;
																	...
																	setSlide:function(e){
																		...
																		if(this.doCssTrans())
																			...
																			openSlide:function(e){
																				...
																				setTimeout(function(){ 
																					n("body").addClass("swipebox-overflow-hidden")},1500);
																				this.setSlide(e)
																			},
																					...
																					getPrev:function(){
																						...
																						if(index>0){
																						...
																						else
																							{
																								...
																								setTimeout(function(){
																									n("#swipebox-slider").removeClass("leftSpring")},500)
																							}
																						},
																						closeSlide:function(){
																							var e=this;
